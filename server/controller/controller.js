...
var getTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                console.error('Error fetching todos:', err_1);
                return [3 /*break*/, 3];
...
var updateTodo = function (req, res) {
    ...
    var toDo = req.body.toDo;
    schema_1.default.findByIdAndUpdate(id, { $set: { toDo: toDo } }, { new: true }).then(function () {
...
var deleteTodo = function (req, res) {
    var id = req.params.id;
    schema_1.default.findByIdAndDelete(id).then(function () {
